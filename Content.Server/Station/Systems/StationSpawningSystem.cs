...
public sealed class StationSpawningSystem : SharedStationSpawningSystem
{
    ...
    private EntityUid SpawnEntity(string prototype, EntityCoordinates coordinates, ProtoId<JobPrototype>? job)
    {
    ...
    /// <param name="station">The station this player is being spawned on.</param>
    public void SetPdaAndIdCardData(EntityUid entity, string characterName, ProtoId<JobPrototype>? job, EntityUid? station)
    {
        ...
        _prototypeManager.TryIndex(jobPrototype.Icon, out var presetJobIcon);
