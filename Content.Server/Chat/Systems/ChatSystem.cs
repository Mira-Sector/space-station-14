...
public sealed partial class ChatSystem : SharedChatSystem
{
    ...
    public const string DefaultAnnouncementSoundPath = "/Audio/Announcements/Default/announce.ogg";
    public SoundSpecifier DefaultAnnouncementSound = new SoundPathSpecifier(DefaultAnnouncementSoundPath);
