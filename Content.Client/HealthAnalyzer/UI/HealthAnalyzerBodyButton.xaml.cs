...
public sealed partial class HealthAnalyzerBodyButton : TextureRect, IHealthAnalyzerBodyButton
{
    ...
    public HealthAnalyzerBodyButton(object identifier, EntityUid owner, HealthAnalyzerBodyItemSprites sprites, SpriteSystem spriteSystem)
    {
        ...
        _hoverSprite = sprites.HoverSprite;
        _selectedSprite = sprites.SelectedSprite;
