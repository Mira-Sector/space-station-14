...
public sealed partial class SurgeryWindow : FancyWindow
{
    ...
    private void UpdateSurgeries()
    {
        ...
        foreach (var surgery in _receiver.AvailableSurgeries)
        {
            ...
            button.OnPressed += _ => OnSurgeryButtonPressed(_receiver, surgery);
    ...
    private void OnSurgeryButtonPressed(ISurgeryReceiver receiver, ProtoId<SurgeryPrototype> surgeryId)
    {
