...
namespace Content.Client.Chemistry.UI
{
    ...
    public sealed partial class ChemMasterWindow : FancyWindow
    {
        ...
        {
            var reagentTransferButton = new ReagentButton(text, amount, id, isBuffer, origin, styleClass);
        ...
        private void UpdateDosageFields(ChemMasterBoundUserInterfaceState castState)
        {
            ...
            var bufferVolume = castState.BufferOutputVolume?.Int() ?? 0;
        ...
        private void UpdateBufferInfo(BoxContainer bufferInfo, IReadOnlyList<ReagentQuantity> bufferReagents, FixedPoint2? bufferVolume, bool isStorageBuffer, string bufferName, ChemMasterSortingType sortingType)
        {
            ...
            {
                bufferInfo.Children.Add(BuildReagentRow(reagent.color, rowCount++, reagent.name, reagent.reagentId, reagent.quantity, true, true, bufferName));
            }
        }
        ...
        private void UpdatePanelInfo(ChemMasterBoundUserInterfaceState state)
        {
            ...
            UpdateBufferInfo(StorageBufferInfo, state.BufferStorageReagents, state.BufferStorageVolume, true, SharedChemMaster.StorageBufferSolutionName, state.SortingType);
            UpdateBufferInfo(OutputBufferInfo, state.BufferOutputReagents, state.BufferOutputVolume, false, SharedChemMaster.OutputBufferSolutionName, state.SortingType);
        }
    }
