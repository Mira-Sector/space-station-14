...
public abstract class SharedBloodstreamSystem : EntitySystem
{
    ...
    {
        DoDamageChangedEvent(ent, args.Args);
    }

    private void OnDamageChanged(Entity<BloodstreamComponent> ent, ref DamageChangedEvent args)
    {
        DoDamageChangedEvent(ent, args);
    }

    private void DoDamageChangedEvent(Entity<BloodstreamComponent> ent, DamageChangedEvent args)
    {
